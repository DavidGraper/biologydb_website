...
include "person_biologydegrees_createcodelists.php";
	...
	<body>
		...
		<div class="container-fluid" style="margin-top:30px">
			<div class="row">
				...
				<!-- Vertical Navbar -->
				<?php insertpersonverticalnavbar($personid, "BiologyDegrees"); ?>
		
				</div>
				<div class="col-sm-10">		
					<h3>Biology Person "<?php echo $personname; ?>" Biology Degrees</h3>
					<br/>
					<table class="table">
						<thead>
							<tr>
								<th>Biology Degree Area</th>
								<th>Biology Degree Type</th>
								<th>Start Date</th>
								<th>End Date</th>
							</tr>
						</thead>
						<tbody>
						    <?php include "person_biologydegrees_read.php"; ?>
						</tbody>
					</table>
					<br>
					<br>
					...
					<hr/>
					<br>
					<h4>Add New Biology Degree:</h4>
					<br>
					<form class="form-horizontal" action="person_biologydegrees_create.php" method="POST">

						<div class="form-group">
							<label class="control-label col-lg-3" for="biologydegreearea">Biology Degree Area:</label>
							<div class="col-lg-9">
							    <?php
						...
						<div class="form-group">
							<label class="control-label col-lg-3" for="biologydegreetype">Biology Degree Type:</label>
							<div class="col-lg-9">
							    <?php
...
<!--
						...
						<div class="form-group">
							<label  class="control-label col-lg-3" for="startingsemester">Starting Semester:</label>
							<div class="col-lg-9">
							    <?php
