...
include "person_ethnicities_createcodelists.php";
	...
	<body>
		...
		<div class="container-fluid" style="margin-top:30px">
			<div class="row">
				...
				<!-- Vertical Navbar -->
				<?php insertpersonverticalnavbar($personid, "Ethnicities"); ?>
		
				</div>
				<div class="col-sm-10">		
					<h3>Biology Person "<?php echo $personname; ?>" Ethnicities</h3>
					<br/>
					<table class="table">
						<thead>
							<tr>
						...
						<tbody>
						    <?php include "person_ethnicities_read.php"; ?>
						</tbody>
					</table>
					<br>
					<br>
					...
					<hr/>
					<br>
					<h4>Add Ethnicity Entry:</h4>
					<br>
					<form class="form-horizontal" action="person_ethnicities_create.php" method="POST">

						<div class="form-group">
							<label class="control-label col-lg-3" for="ethnicityid">Ethnicity:</label>
							<div class="col-lg-9">
							    <?php
