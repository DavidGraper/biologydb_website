...
$html .= '</td><td>&nbsp;</td><td><h3>Biology Department Graduate Student Contact Information</h3><br/><h4>' . $todays_date . '</h4></td>/</tr></table>';
...
$filename = "BioDB Report - Graduate Student Contact Info - " . $todays_date . ".pdf";
