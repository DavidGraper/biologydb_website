	...
	<head>
		...
		<script type="text/javascript">
                        ...
                        function drawChart() {
                            ...
                            dataTable.addRows([
<?php
$spring2023classes = getclassschedulerows(2023, "Spring", "M");

foreach ($spring2023classes as $value) {
	echo($value . ",");
}
?>
                            ]);
                            ...
                            dataTable1.addRows([
<?php
$spring2023classes = getclassschedulerows(2023, "Spring", "T");
...
?>
                            ...
                            dataTable2.addRows([
<?php
$spring2023classes = getclassschedulerows(2023, "Spring", "W");
...
?>
                            ...
                            dataTable3.addRows([
<?php
$spring2023classes = getclassschedulerows(2023, "Spring", "TH");
...
?>
                            ...
                            dataTable4.addRows([
<?php
$spring2023classes = getclassschedulerows(2023, "Spring", "F");
	...
	<body>
		...
		<div class="container-fluid" style="margin-top:30px">
			<div class="row">
				...
				<!-- Vertical Navbar -->
				<?php insertclassesverticalnavbar("spring2023"); ?>

				<div class="col-sm-10">

					<h4>Biology Building Classroom Use</h4>
					<h5>Spring Semester 2023</h5>
					<br/>
					<h5>Mondays</h5>
					<br/>
