	...
	<body>
		...
		<div class="container-fluid" style="margin-top:30px">
			<div class="row">
				...
				<!-- Vertical Navbar -->
				<?php insertpersonverticalnavbar($personid, "Advisors"); ?>
		
				</div>
				<div class="col-sm-10">		
					<h3>Biology Person "<?php echo $personname; ?>" Advisors</h3>
					<br/>
					<table class="table">
						<thead>
							<tr>
						...
						<tbody>
						    <?php include "person_advisors_read.php"; ?>
						</tbody>
					</table>
					<br>
					<br>
					...
					<hr/>
					<br>
					<h4>Add New Advisor:</h4>
					<br>
					<form class="form-horizontal" action="person_advisors_create.php" method="POST">
						<div class="form-group">
							<label class="control-label col-lg-3" for="advisorid">Advisor:</label>
							<div class="col-lg-9">
							    <?php
